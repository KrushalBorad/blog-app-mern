                    ...
                    <div className="flex space-x-4">
                      <button
                        ...
                        className={`flex items-center ${
                          user && post.likes && post.likes.map(id => id?.toString()).includes(user.id.toString())
                      ...
                      >
                        <svg
                          ...
                          viewBox="0 0 20 20"
                          fill={user && post.likes && post.likes.map(id => id?.toString()).includes(user.id.toString()) ? 'currentColor' : 'none'}
                          stroke="currentColor"
                        >
