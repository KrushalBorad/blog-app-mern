...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-gradient-to-r from-purple-50 to-pink-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl transform hover:shadow-2xl transition-all duration-300">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <Link href="/register" className="font-medium text-purple-600 hover:text-pink-600 transition-colors duration-300">
              Sign up here
            </Link>
          </p>
        </div>
